...
This repository contains solutions to a wide range of programming challenges involving mathematical computation, decision-making logic, loops, functions, arrays, string processing, file handling, and data validation.
...
- [Four-Digit Halver](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/four-digit-halver.cpp)
- [Four-Digit Sum](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/four-digit-sum.cpp)
- [Hello World Print](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/hello-world-print.cpp)
- [Inches to Feet Converter](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/inches-to-feet.cpp)
- [Medical Reading Decimal Swap](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/medical-reading-decimal-swap.cpp)
- [PIN Generator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/pin-generator.cpp)
- [Power Unit Converter](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/power-unit-converter.cpp)
- [Rectangle Area Calculator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/rectangle-area-v2.cpp)
- [Rectangle Perimeter Calculator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/rectangle-perimeter.cpp)
- [Seconds to Hours-Minutes-Seconds Converter](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/seconds-to-hms.cpp)
- [Seconds to Minutes Converter](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/seconds-to-minutes.cpp)
- [Six-Digit Trisector](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/six-digit-trisector.cpp)
- [Sleep Cycle Calculator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/sleep-cycle-calculator.cpp)
- [Sphere Volume Calculator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/sphere-volume.cpp)
- [Sphere Volume Calculator v2](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/sphere-volume-v2.cpp)
- [Student Average Mark Calculator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/student-average-mark.cpp)
- [Three-Digit Splitter](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/three-digit-splitter.cpp)
- [Three-Digit Sum](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/arithmetic-and-operators/three-digit-sum.cpp)
...
- [Mark Bonus Calculator (Tiered)](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/mark-bonus-tiered.cpp)
- [Mark Bonus Calculator (Multi-Tiered)](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/mark-bonus-multitiered.cpp)
- [Membership Discount Billing](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/membership-discount-billing.cpp)
- [Perfect Square Checker](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/perfect-square-checker.cpp)
- [Shipping Cost Calculator](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/shipping-cost-calculator.cpp)
- [Smart Home Hub Controller](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/smart-home-hub.cpp)
- [Three Numbers Ascending Sort](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/three-numbers-ascending-sort.cpp)
- [Triangle Classifier](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/triangle-classifier.cpp)
- [Two-Digit Sum or Product](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/two-digit-sum-or-product.cpp)
- [Water Bill Calculator (Two-Tier)](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/water-bill-two-tier.cpp)
- [Water Bill Calculator (Three-Tier)](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/conditionals-and-branching/water-bill-three-tier.cpp)
...
- [Summation Series Printer](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/loops/summation-series-printer.cpp)
- [Symmetric Number Triangle](https://github.com/Abdullah-Abdul-Azeem/cpp-fundamentals/blob/main/loops/symmetric-number-triangle.cpp)
